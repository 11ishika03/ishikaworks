        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative pl-8 sm:pl-12 py-6 group">
            <div className="bg-card rounded-2xl p-8 border border-border shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="flex flex-col sm:flex-row items-start mb-4 group-hover:text-dark-brown transition-colors">
                <div className="flex items-center mb-2 sm:mb-0">
                  <h3 className="text-2xl font-heading font-medium text-dark-brown">AI-ML Developer Intern</h3>
                </div>
              ...
              <h4 className="text-lg font-medium mb-6 text-dark-brown">Next24tech Technology & Services</h4>
              
              <ul className="list-none space-y-4 text-foreground/80">
                <li className="flex items-start">
                  <div className="w-2 h-2 rounded-full bg-dark-brown mt-2 mr-4 flex-shrink-0"></div>
            ...
            <div className="absolute left-0 top-8 sm:left-4 h-full w-[2px] bg-dark-brown/30"></div>
            <div className="absolute left-0 sm:left-4 top-8 w-4 h-4 rounded-full bg-dark-brown -translate-x-1/2 z-10 shadow-sm"></div>
          </div>
        </div>
      </div>
    </section>
